...
namespace ShopOnEFLayer.Migrations
{
    ...
    [Migration("20220713035103_addQuestionAnswer")]
            ...
            modelBuilder.Entity("ShopOnEFLayer.Models.Answer", b =>
                {
                    ...
                    b.Property<int>("QuestionForeignKey")
                        .HasColumnType("int");

                    b.HasKey("AnswerId");

                    b.HasIndex("QuestionForeignKey")
                        .IsUnique();

                    b.ToTable("CustomerQueryAnswer");
                });
            ...
            modelBuilder.Entity("ShopOnEFLayer.Models.Answer", b =>
                {
                    b.HasOne("ShopOnEFLayer.Models.Question", "Question")
                        .WithOne("Answer")
                        .HasForeignKey("ShopOnEFLayer.Models.Answer", "QuestionForeignKey")
